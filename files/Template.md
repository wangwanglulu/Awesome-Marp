...
<!-- _footer: "" --> 
<!-- _paginate: "" --> 
<!-- _header: ![](https://wangwanglulu-1303439199.cos.ap-shanghai.myqcloud.com/sufe.png) -->

# <!-- fit --> Joint vs Separate Crowdsourcing Contests
...
## Motivation
<!-- _class: navbar -->
<!-- _header: \ **Motivation** *Model Setup* *Main Results* *Extensions* *Conclusion*  *Takeaways*-->
...
#### Assumptions
1. **Contestants**: the number of contestants is $\small n\geq 2$
2. 
